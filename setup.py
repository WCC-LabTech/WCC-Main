...
if __name__ == '__main__':
    ...
    repos = [
         ...
         },
        {
            'name': 'time-tracking', 
            'urls': {
                'https': 'https://github.com/WCC-LabTech/Time_Tracking.git',
                'ssh': 'git@github.com:WCC-LabTech/Time_Tracking.git',
            },
         },
        {
            'name': 'faculty-request', 
            'urls': {
                'https': 'https://github.com/WCC-LabTech/Faculty_Request.git',
                'ssh': 'git@github.com:WCC-LabTech/Faculty_Request.git',
            },
         },
        {
            'name': 'inventory-management', 
            'urls': {
                'https': 'https://github.com/WCC-LabTech/Inventory-Management.git',
